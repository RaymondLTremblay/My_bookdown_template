# (Appendix) Ejercicios {.unnumbered}
...
## Cual es el nombre del bateador (id_jugador) que estuvo más veces "al_bate" {.unnumbered}
...
## 2. ¿Cual son las "ligas" de baseball (pelota) que esta incluida en este archivo? {.unnumbered}
...
## 3. Selecciona los años (1900, 1950, 2000 y 2020) y jonrones y hacer una tabla por año que demuestra el maximo de jonrones para cada año {.unnumbered}
...
## 4. Haz una tabla de la los jugadores que juraron más años {.unnumbered}
...
## 5. Selecciona solamente la liga "AL", los años desde de 2000 en adelande, y determina cual es la suma de "carreras" anotadas por cada equipo. {.unnumbered}
