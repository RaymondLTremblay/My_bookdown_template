...
```{r}
vuelos %>% select(anio, mes, dia, horario_salida, aerolinea) |> 
...
### ¿Qué pasa con los valores y resultados sin sentido?
...
Aqui un website que recopila la cantidad de personas vacunadas en los EEUU.
