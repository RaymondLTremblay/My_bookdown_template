...
\noindent Exponente or Sobrescrito: $\mathrm{O^-}$

\noindent Subíndice: $\mathrm{CH_4}$

Para apilar números o letras como en $\mathrm{Fe_2^{2+}}$, primero se define el subíndice y luego el superíndice.

\noindent punto se usa la palabra **bullet**: CuCl $\bullet$ $\mathrm{7H_{2}O}$ `CuCl $\bullet$ $\mathrm{7H_{2}O}$`


\noindent Delta: $\Delta$

\noindent Flecha de Reacción: $\longrightarrow$ or  $\xrightarrow{solution}$

\noindent Flecha de Resonancia: $\leftrightarrow$

\noindent Flechas de reacción reversibles: $\rightleftharpoons$

### Tipografica de reaciones
